	...
	if(($_SESSION['login_member']==true)&& 
	  ($_SESSION['aktif']=="2")){
		...
		if ($action == "delete")
		{
			...
			if ($delete_query) echo "Record $id berhasil dihapus!<br><META HTTP-EQUIV=Refresh CONTENT='2; URL=lihatdata_hasil.php'>";
			else echo "Gagal menghapus record<br><META HTTP-EQUIV=Refresh CONTENT='2; URL=lihatdata_hasil.php'>";
		}	
					...
					<select name="tahun_ajaran">
						...
						<option value="2030">2030</option>
								...
								<tr>
									...
									<form action="lihatdata_hasil.php" method="POST">
