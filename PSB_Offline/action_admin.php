	...
	if(($_SESSION['login_member']==true)&& 
	  ($_SESSION['aktif']=="2")){
		...
		if ($action == "delete")
		{
			...
			if ($delete_query) echo "Record $id berhasil dihapus!<br><META HTTP-EQUIV=Refresh CONTENT='2; URL=lihatdata_admin.php'>";
			else echo "Gagal menghapus record<br><META HTTP-EQUIV=Refresh CONTENT='2; URL=lihatdata_admin.php'>";
		}		
		else 
		{
	...
	?><title>ADMIN SMA KARTIKA SILIWANGI 1</title>
		...
		<table border='1' width='40%' cellpadding='3'  cellspacing='3' align='center' bgcolor="#FFFFF">
			...
			<tr>
				...
				</form><form action="lihatdata_admin.php" method="POST"><input type="submit" name="kirim" value="Batal"/></form>
				</td>
			</tr>
		</table>
	<?php
