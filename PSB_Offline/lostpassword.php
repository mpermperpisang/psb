...
<script type="text/javascript" src="js/js_form_password.js"></script>
    <body>
		...
		<center>
			<div id="content">
				<div id="left-side">
					<div id="profile">
						<h1>Fasilitas Forgot Password</h1>
						<table width="100%">
	...
	<table width="40%" border="0" cellspacing="2" cellpadding="2">
      <tr>
        ...
        <td>:</td>
        <td>
        	<input name="password" type="password" class="input_password"/>
        </td>
      </tr>
      <tr>
        <td colspan="3" align="center"><input type="submit" class='tombol' value="Reset Password" onclick="return aksi_daftar();"/></td>
      </tr>
	</table>
