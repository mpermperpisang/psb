...
<html>
	...
	<body>	
		<table style="font-size:11px;font-family:'arial';text-align:center;" border='0' width="90%" align="center" cellpadding="3" cellspacing="3">
			...
			<blink>Anda belum log in atau tidak berhak mengakses halaman ini.. Silahkan log in sebagai calon siswa terlebih dahulu atau daftar !!</blink>
			<tr>
				...
				<td align="right">
					<?php 
						if(isset($_SESSION['login_member']))
						{
							...
							{
					?>
								<input type="button" value="Log Out Operator" onClick="window.location.href='logout.php'" align="right">
					<?php
				 			}
							else if (($_SESSION['login_member']==true)&&($_SESSION['aktif']=="2"))
							{
					?>
								<input type="button" value="Log Out Admin" onClick="window.location.href='logout.php'" align="right">
					<?php
							}
						} 
						else
						{
					?>
							<input type="button" value="Login" onClick="window.location.href='home.php'" align="right">
					<?php
						}
					?>		
