			...
			<table style="font-size:11px;font-family:'arial';text-align:center;" border='0' width="99%" align="center" cellpadding="3" cellspacing="3">
				...
				<tr>
					<td colspan="12" align="left">
						<form name="form1" method="POST" action="cari_operator.php">
					...
					<td width="500"></td>
					<td align="right">
						<input type="button" value="Home" onClick="window.location.href='operator.php'">
						<input type="button" value="Update Tabel Siswa" onClick="window.location.href='insert_tabel_operator.php'">
						<input type="button" value="Isi Formulir Pendaftaran" onClick="window.location.href='psb_operator.php'"></td>
					</td>
				</tr>
				<tr>
					<td colspan="12">					
					...
					<td width="500"></td>
					<td align="right">
						<form name="form2" method="POST" action="lihatdata_seleksi_operator.php">
